...
class Agent:
        ...
        for trial in range(self.num_trials):
            ...
            while replay:
                ...
                if max_evm > self.evm_thresh:
                    ...
                    Q_history      = np.vstack((Q_history, self.Q2.ravel()))
    ...
    def explore_two_moves(self, world, states=None, num_trials=None, online_learning=True, save_folder=None, T_forget=False):
        ...
        for trial in range(self.num_trials*2):
            ...
            if num_steps != 0:
                ...
                Q2_history       = self.Q2.flatten()
                
                replay_gain1     = np.empty((0, 8*4))
                Q1_history       = self.Q1.flatten()
                replay_planes    = []
            ...
            while replay:
                ...
                if max_evm > self.evm_thresh:
                    ...
                    Q1_history      = np.vstack((Q1_history, self.Q1.ravel()))
                    
                    replay_gain2    = np.vstack((replay_gain2, gain_move2))
                    Q2_history      = np.vstack((Q2_history, self.Q2.ravel()))
            ...
            if num_steps == 2:
                ...
                if save_folder is not None:
                    ...
                    np.savez(save_name, move=[[prev_s, prev_a, prev_r, prev_s1], [s, a, r, s1]], T=self.T2, 
                             replay_gain=[replay_gain1, replay_gain2], Q_history=[Q1_history, Q2_history], replay_backups=replay_backups, 
