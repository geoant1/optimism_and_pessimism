...
class Agent:
    ...
    def explore_one_move(self, world, state_arr, states, evm_thresh, num_trials, online_learning=True, save_folder=None):
        '''Run 1-move trials'''
        ...
        for trial in range(num_trials):
            ...
            while replay:
                ...
                if max_evm > evm_thresh:
                    ...
                    Q_history      = np.vstack((Q_history, self.Q2.flatten()))
            ...
            if save_folder is not None:
                ...
                np.savez(save_name, move=[s, a, r, s1], T=self.T2, replay_gain=replay_gain, evm_thresh=evm_thresh,
