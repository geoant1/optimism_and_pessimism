...
class Prior_class(object):
        ...
        def return_priorprob(self,value):
                ...
                elif self.priorname == 'beta':
                        return scipy.stats.beta.pdf(value, self.hyperparams[0], self.hyperparams[1])
        def prior(self):
                '''
                ...
                if self.priorname =="gamma":
                        ...
                        return float(np.random.beta(self.hyperparams[0],self.hyperparams[1],size=1))
