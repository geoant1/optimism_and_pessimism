            ...
            # Second move    
                ...
                if online_learning:
                    ...
                    if prev_a == 0 or prev_a == 1:
                        prev_a_opp = [0, 1]
                        probs      = policy_choose_moves([np.delete(q_vals1, prev_a_opp), np.delete(q_vals2, prev_a_opp)], [self.beta1, self.beta2], np.delete(self.biases, prev_a_opp))
