...
class Agent:
    ...
    def __init__(self, p: dict):    
        ...
        self.alpha1r          = p['alpha1r']
        self.alpha2r          = p['alpha2r']        
    ...
    def explore_one_move(self, world, state_arr, states=None, num_trials=None, online_learning=True):
        ...
        for trial in range(self.num_trials):
            ...
            if replay:
                self.Q2 = replay_1move(self.Q2.copy(), self.T2, world, self.beta, self.alpha2r, self.evm_thresh)
    ...
    def explore_two_moves(self, world, state_arr, states=None, num_trials=None, online_learning=True, T_forget=False):
        ...
        for trial in range(self.num_trials*2):
            ...
            # Second move    
                ...
                m_list.append([[prev_s, prev_a, prev_r, s], [s, a, r, s1]])
            ...
            if replay:
                self.Q1, self.Q2 = replay_2moves(self.Q1.copy(), self.Q2.copy(), self.T2, world, self.evm_thresh, self.beta2, self.beta1, self.alpha2r, self.alpha1r)
